...
class APiHelper {
  ...
  Future<List?> getWallpaper({String query = "all"}) async {
    String wallpaperAPI =
        "https://pixabay.com/api/?key=36873436-b3162e2779ec114a35661b7fa&q=$query&safesearch=true&orientation=vertical&per_page=100";
